...
export function App() {
  const publications = [
    {
      authors: "Rafael Barbosa de Carvalho, Elloá B. Guedes, Carlos Maurício Serodio Figueiredo.",
      title: " Detecção Inteligente de Falhas em Pavimentações Asfálticas com Redes Neurais Convolucionais Regionais.",
